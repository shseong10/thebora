...
public class PayService {
    ...
    // 포인트 결제요청 전송
    public PointPayReadyResponse pointPayReady(String name, int totalPrice) {
        ...
        parameters.put("approval_url", "http://localhost/hotdeal/order/pointPay/completed"); // 성공 시 redirect url
        ...
        ResponseEntity<PointPayReadyResponse> responseEntity = template.postForEntity(url, requestEntity, PointPayReadyResponse.class);
