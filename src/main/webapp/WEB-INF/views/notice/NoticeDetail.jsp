...
<section>
    <div class="notice">
        ...
        <div class="action">
            ...
            <button id="update-btn" onclick="location.href='/notice/update?n_num=' + ${nDto.n_num}">수정</button>
            </sec:authorize>
        </div>
    </div>
</section>
...
<script>
    function upload(n_num){
        location.href = '/notice/update?n_num=' + n_num;
    }

    const del = function(n_num){
        let conf = confirm('진짜 삭제하시겠습니까?');
        if(conf === true){
            location.href = '/notice/delete?n_num=' + n_num;
        }
    }
    $('.img-none').hide();
